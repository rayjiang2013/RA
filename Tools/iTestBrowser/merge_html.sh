...
### see .py   SOURCE_DIR_1="/work/mypy/Wrappers/itest_params_v1-KEEP"
### see .py   SOURCE_DIR_2="/work/mypy/Wrappers/NEW_api_pseudo-code_html"
TARGET_DIR="/work/mypy/Wrappers/HERO_test_params"
...
do
#    echo $x
#    python mergeHTML.py /Users/rcollazo/.jenkins/userContent/itest_actions/itest_params/$x.html

	python mergeHTML.py $x > $TARGET_DIR/$x.html
